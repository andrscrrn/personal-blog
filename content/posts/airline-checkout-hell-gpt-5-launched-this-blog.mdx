...
date: 2025-08-07
description: What started as a simple plan to buy flights to Europe turned into checkout bugs, support calls, and—unexpectedly—the birth of this blog with a little help from GPT‑5.
tags:
  - travel
  - airlines
  - customer-support
...
All of this was happening while I was in bed with my laptop, and on the TV I was watching videos about GPT‑5. The demos were impressive—especially how users no longer have to pick a model. That sparked a thought: I needed to vent somewhere. A blog would be perfect.
